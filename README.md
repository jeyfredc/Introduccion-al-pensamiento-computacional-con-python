...
La forma de agregar una nueva llave al diccionario se hace muy parecido a la re asignación de valor de una llave y cuando queremos borrar una llave se utiliza el keyword del
